...
func main() {
	...
	_, err = coll.InsertOne(ctx, bson.M{
		"plaintext1": fmt.Sprintf("%s_%s","hello world2",t.Format("2006-01-02 15:04:05")), 
		"plaintext": 1, 
		"ssn":       "123-01-67899",
		"altname":   "localdemokeyname",
	})
	if err != nil {
...
func createDataKey() {
	...
	dataKeyOpts := options.DataKey().SetKeyAltNames([]string{"localdemokeyname"})
